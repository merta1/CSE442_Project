...
function LoggedInText(props) {
  return (
    <a className="nav-link" href="#/" onClick={() => Logout(props)}>
      ...
      newDebateText = (
        <li className="nav-item">
          <a
            className="nav-link"
            href="#/new-debate"
            onClick={() => this.handleViewChange("StartNewDebate")}
          >
            Start a New Debate
          </a>
        </li>
    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <a
          ...
          href="#/"
          onClick={() => this.handleViewChange("DebateList")}
        >
          Bad-Ass Debate App
        </a>
        <button
        ...
        <div className={`${classOne}`} id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            {newDebateText}
            <li className="nav-item">{logintext}</li>
          </ul>
